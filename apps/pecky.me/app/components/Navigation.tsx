...
export default function Navigation() {
  ...
  const getPeckyWorthInSupra = (): string => {
    ...
    const peckyAmount =
      Number(state.peckyBalance) / Math.pow(10, PECKY_DECIMALS);
        ...
        >
          ...
          >
            {circulatingSupply !== null
              ? formatMicroUnits(circulatingSupply) + " $Pecky"
              : "–"}
          </div>
            ...
            return (
              <Link
                ...
                className={flex({
                  ...
                  py: "0.5rem",
                  px: "0.5rem",
                  color: isActive ? "#ff7700" : "#a06500",
                  textDecoration: "none",
                  fontSize: "0.6875rem",
                  fontWeight: "600",
                  transition: "all 0.2s",
                  _hover: { color: "#ff7700", transform: "scale(1.05)" },
                })}
              >
                <div
                  className={css({
                ...
                <span
                  className={css({
                    borderBottom: isActive ? "2px solid #ff7700" : "none",
