      ...
      <RetroBox startOpen={false}>
        ...
        <RetroBox.Content>
          ...
          >
            ...
            >
              ...
              <div className={css({ color: "#8a4000" })}>
                ...
                <ul className={css({ pl: "20px", m: "4px 0 0 0" })}>
                  ...
                  <li>
                    When reactivated, you start earning from zero again.
                  </li>
                </ul>
              </div>
            </div>
            ...
            >
              <li>
                Attach Chicken Wings Original NFTs to increase your APY.
              </li>
              <li>
                Per rarity boost:
            ...
            {ownedNodes.map((node) => (
              ...
              >
                ...
                <div className={css({ mb: "12px" })}>
                  ...
                  >
                    <div className={css({ fontSize: "12px", color: "#b48512" })}>
                      ID: {node.nodeId}
                    </div>
                    <button
                ...
                {node.availableRarities && node.availableRarities.length > 0 && (
                  <div className={css({ mb: "12px" })}>
                    <div
                      className={css({
                        fontSize: "12px",
                ...
                return (
                  <div
                    ...
                    className={css({
                      p: "14px",
                      bg:
                        selectedNodeId === node.nodeId ? "#fff8e8" : "#fffbe8",
                      borderRadius: "12px",
                      border:
                ...
                >
                  <div>
                    ...
                    >
                      Amount:{" "}
                      <strong>
                        {(Number(unstake.amountMicro) / 1_000_000).toLocaleString()}{" "}
                        $Pecky
                      </strong>
                    </div>
                  </div>
